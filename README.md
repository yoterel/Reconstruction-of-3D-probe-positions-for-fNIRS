...
- CapNet model file can be downloaded from [here](ftp://anonymous@yotablog.com:1@ftp.yotablog.com/model.rar). Notice this model was created using matlab 2018b, and is loadable only using a supporting matlab version (the model is a DAG network object).
