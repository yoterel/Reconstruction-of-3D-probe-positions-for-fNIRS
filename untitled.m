...
% Last Modified by GUIDE v2.5 02-Aug-2019 11:42:11
...
function untitled_OpeningFcn(hObject, eventdata, handles, varargin) %#ok<*INUSL>
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.pos, 'String',  "AAAAA");
%set(handles.pos, 'String',  get(gca,'CurrentPoint'));
end
